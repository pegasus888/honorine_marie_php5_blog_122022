<?php if($action == 'add'):?>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <h1 class="h3 mb-3 fw-normal">Create comment</h1>
        ...
        <input value="<?=old_value('comment')?>" name="comment" type="text" class="form-control mb-2" id="floatingInput" placeholder="Comment">
...
<?php elseif($action == 'edit'):?>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <h1 class="h3 mb-3 fw-normal">Edit comment</h1>
        ...
        <?php if(!empty($row)):?>
            ...
            <div class="form-floating">
            <input value="<?=old_value('comment', $row['comment'])?>" name="comment" type="text" class="form-control mb-2" id="floatingInput" placeholder="Username">
            <label for="floatingInput">Username</label>
            </div>
            <?php if(!empty($errors['comment'])):?>
            <div class="text-danger"><?=$errors['comment']?></div>
...
<?php elseif($action == 'delete'):?>
    ...
    <form method="post">
        ...
        <?php if(!empty($row)):?>
            ...
            <div class="form-floating">
            <div class="form-control mb-2" ><?=old_value('comment', $row['comment'])?></div>
            </div>
            <?php if(!empty($errors['comment'])):?>
            <div class="text-danger"><?=$errors['comment']?></div>
            <?php endif;?>
...
<h4>
    Comments
    <a href="<?=ROOT?>/admin/comments/add">
